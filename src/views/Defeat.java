...
public class Defeat {
	public static void display() {
		...
		Image backgroundImage = new Image("defeat.png.jpg");

		// Create a BackgroundSize object to fit the window size and center the
		// image
		...
		// Create a BackgroundImage object with the image, repeat option,
		// sizing, and position
		...
		layout.getChildren().addAll(quit);
